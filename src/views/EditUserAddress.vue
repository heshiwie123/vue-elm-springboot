...
onMounted(()=>{
  ...
  axios.get(`deliveryAddress/getDeliveryAddressById?daId=${daId.value}`).then(response => {
    deliveryAddress.value = response.data.data.deliveryAddress;
  }).catch(error => {
    console.error(error);
  });
})
// function getUserAddress(){
//   axios.get('deliveryAddress/listDeliveryAddressByUserId',user.value.userId).then(respone=>{
//     deliveryAddressList.value=respone.data.data.deliveryAddresses
//   })
// }
function editUserAddress() {
  ...
  axios.post('deliveryAddress/updateDeliveryAddress', deliveryAddress.value).then(response => {
